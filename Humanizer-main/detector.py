...
class AITextDetector:
    ...
    def load_model(self, model_name: str = "roberta-base-openai-detector") -> bool:
        ...
        try:
            ...
            self.tokenizers[model_name] = AutoTokenizer.from_pretrained(hf_model_name, cache_dir="models")
            self.models[model_name] = AutoModelForSequenceClassification.from_pretrained(hf_model_name, cache_dir="models")
